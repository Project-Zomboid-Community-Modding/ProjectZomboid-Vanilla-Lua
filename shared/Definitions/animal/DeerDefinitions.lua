...
AnimalDefinitions.animals["fawn"].collisionSize = 0.24;
...
AnimalDefinitions.animals["fawn"].corpseSize = 1.5;
...
AnimalDefinitions.animals["doe"].collisionSize = 0.32;
...
AnimalDefinitions.animals["doe"].corpseSize = 2.5;
...
AnimalDefinitions.animals["buck"].collisionSize = 0.32;
