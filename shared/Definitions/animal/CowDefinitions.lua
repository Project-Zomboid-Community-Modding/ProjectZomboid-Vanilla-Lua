...
AnimalDefinitions.animals["cowcalf"].minBlood = 500; -- when butchering you can take off the blood, depending on animal's size the ammount of blood will be between min & max, in cl (so 100 = 1L)
