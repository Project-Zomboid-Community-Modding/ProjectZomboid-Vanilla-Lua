...
ProceduralDistributions.list = {
	...
	GunStoreAmmunition = {
		...
		items = {
			...
			"Bullets9mmBox", 20,
			"Bullets9mmBox", 10,
			"Bullets9mmCarton", 0.1,
			"ShotgunShellsBox", 20,
			"ShotgunShellsBox", 10,
			"ShotgunShellsCarton", 0.1,
		},
		junk = {
			rolls = 1,
			items = {
	...
	GunStoreCases = {
		...
		items = {
			...
			"Bag_RifleCaseClothCamo", 10,
			"Bag_RifleCase", 50,
			"Bag_RifleCase", 20,
			"Bag_RifleCaseGreen", 10,
			"PistolCase1", 10,
		},
		junk = {
			rolls = 1,
	...
	UniversityLibraryBiography = {
		rolls = 4,
		items = {
			"BookFancy_Biography", 20,
			"BookFancy_Biography", 10,
			"Book_Biography", 20,
			"Book_Biography", 20,
			"Book_Biography", 10,
			"Book_Biography", 10,
	...
	UniversityLibraryBusiness = {
		rolls = 4,
		items = {
			"BookFancy_Business", 20,
			"BookFancy_Business", 10,
			"Book_Business", 20,
			"Book_Business", 20,
			"Book_Business", 10,
			"Book_Business", 10,
	...
	UniversityLibraryComputer = {
		rolls = 4,
		items = {
			"BookFancy_Computer", 20,
			"BookFancy_Computer", 10,
			"Book_Computer", 20,
			"Book_Computer", 20,
			"Book_Computer", 10,
			"Book_Computer", 10,
	...
	UniversityLibraryGeneralReference = {
		rolls = 4,
		items = {
			"BookFancy_GeneralReference", 20,
			"BookFancy_GeneralReference", 10,
			"Book_GeneralReference", 20,
			"Book_GeneralReference", 20,
			"Book_GeneralReference", 10,
			"Book_GeneralReference", 10,
	...
	UniversityLibraryScience = {
		rolls = 4,
		items = {
			"BookFancy_Science", 20,
			"BookFancy_Science", 10,
			"Book_Science", 20,
			"Book_Science", 20,
			"Book_Science", 10,
			"Book_Science", 10,
	...
	UniversityStorageAnthropology = {
		...
		items = {
			...
			"NecklaceLong_SkullMammal_Teeth", 1,
