...
KeyNamer.RoomSubstrings:add("clothingstor");
KeyNamer.RoomSubstrings:add("cornerstore");
KeyNamer.RoomSubstrings:add("departmentstor");
KeyNamer.RoomSubstrings:add("donut_");
KeyNamer.RoomSubstrings:add("electronicsstor");
KeyNamer.RoomSubstrings:add("furniturestor");
KeyNamer.RoomSubstrings:add("gasstor");
KeyNamer.RoomSubstrings:add("generalstore");
KeyNamer.RoomSubstrings:add("giftstor");
...
KeyNamer.RoomSubstrings:add("jewelrystor");
...
KeyNamer.RoomSubstrings:add("sewingstor");
KeyNamer.RoomSubstrings:add("sportstor");
KeyNamer.RoomSubstrings:add("sushi");
KeyNamer.RoomSubstrings:add("toolstore");
KeyNamer.RoomSubstrings:add("toystore");
KeyNamer.RoomSubstrings:add("zippeestor");
